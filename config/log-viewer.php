...
return [
    ...
    */
    ...
    'include_files' => [
        // Only this application's own log. The server's logs (php-fpm,
        // nginx, ...) live outside the project and usually aren't readable
        // by the web user anyway, so listing them here only produces
        // entries that fail to open.
        'laravel*.log',
    ],
